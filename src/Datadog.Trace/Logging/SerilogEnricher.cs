...
namespace Datadog.Trace.Logging
{
    internal class SerilogEnricher : ILogEnricher
    {
        ...
        public void Enrich(ILogEvent logEvent, object propertyFactory)
        {
            ...
            var traceIdProperty = _propertyFactory(CorrelationIdentifier.SerilogTraceIdKey, _valueFactory(activeScope.Span.Context.TraceId.ToString()));
            var spanIdProperty = _propertyFactory(CorrelationIdentifier.SerilogSpanIdKey, _valueFactory(activeScope.Span.Context.SpanId.ToString()));
