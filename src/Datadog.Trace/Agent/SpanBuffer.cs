...
namespace Datadog.Trace.Agent
{
    internal class SpanBuffer
    {
        ...
        private readonly IMessagePackFormatter<ArraySegment<ISpan>> _formatter;
        ...
        public SpanBuffer(int maxBufferSize, IFormatterResolver formatterResolver)
        {
            ...
            _formatter = _formatterResolver.GetFormatter<ArraySegment<ISpan>>();
        }
        ...
        public bool TryWrite(ArraySegment<ISpan> trace, ref byte[] temporaryBuffer)
        {
